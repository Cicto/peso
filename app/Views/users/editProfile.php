        ...
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                <li class="breadcrumb-item text-muted">
                    <a href="#" class="text-muted text-hover-primary">Edit Profile Information</a>
                </li>
            </ul>
        </div>
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <div class="flex-column current" data-kt-stepper-element="content">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12 col-md-6 fv-row fv-plugins-icon-container">
                                                            <select class="form-select form-select-search form-control form-control-solid" aria-label="Default select example" id="birthplace-province" required="">
                                                                ...
                                                                <?php 
                                                                    $birthplace_provinces = $provinces;
                                                                    if($userBirthPlace){
                                                                        $birthplace_provinces = $userBirthPlace->provinces;
                                                                    }
                                                                    foreach ($birthplace_provinces as $key => $province):
                                                                ?>
                                                                    <option value="<?=$province->provCode?>" <?=$userBirthPlace ? $userBirthPlace->selected_province === $province->provCode?'selected':'':''?>><?= ucwords(strtolower($province->provDesc)) ?></option>
                                                                <?php endforeach;?>
                                                            </select>
                                                            <div class="fv-plugins-message-container invalid-feedback"></div>
                                                        </div>
                                                        <div class="col-12 col-md-6 fv-row fv-plugins-icon-container">
                                                            <select class="form-select form-select-search form-control form-control-solid" aria-label="Default select example" id="birthplace-city" name="birth_place_city_mun_id" required="">
                                                                ...
                                                                <?php 
                                                                    if($userBirthPlace):
                                                                    foreach ($userBirthPlace->cities as $key => $cities):?>
                                                                    <option value="<?=$cities->id?>" <?=$userBirthPlace->selected_city === $cities->citymunCode?'selected':''?>><?= ucwords(strtolower($cities->citymunDesc)) ?></option>
                                                                <?php endforeach;
                                                                    endif;
                                                                ?>
                                                            </select>
                                            ...
                                            <div class="row gx-0 gx-md-2 mb-6">
                                                ...
                                                <div class="col-lg-8">
                                                    <input type="text" value="<?=$userInformation->religion?>" name="religion" id="religion" class="form-control form-control-lg form-control-solid" placeholder="Religion">
                                                </div>
                                            </div>
                                            <!-- CIVIL STATUS -->
                                            <div class="row gx-0 gx-md-2 mb-6">
                                                ...
                                                <div class="col-lg-8">
                                                    <select class="form-select form-control form-control-solid" aria-label="Civil Status" name="civil_status" id="civil-status">
                                                        ...
                                                        <option value="Single" <?=$userInformation->civil_status == "Single" ? "selected" : "" ?>>Single</option>
                                                        <option value="Married" <?=$userInformation->civil_status == "Married" ? "selected" : "" ?>>Married</option>
                                                        <option value="Widowed" <?=$userInformation->civil_status == "Widowed" ? "selected" : "" ?>>Widowed</option>
                                                        <option value="Separated" <?=$userInformation->civil_status == "Separated" ? "selected" : "" ?>>Separated</option>
                                                        <option value="Live-in" <?=$userInformation->civil_status == "Live-in" ? "selected" : "" ?>>Live-in</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <!-- HEIGHT -->
                                            <div class="row gx-0 gx-md-2 mb-6">
                                                ...
                                                <div class="col-lg-8">
                                                    <div class="input-group">
                                                        <input type="number" value="<?=$userInformation->height?>" name="height" id="height" min="10" placeholder="00" class="form-control form-control-lg form-control-solid">
                                            ...
                                            <div class="row gx-0 gx-md-2 mb-6">
                                                ...
                                                <div class="col-lg-8">
                                                    <input type="text" value="<?=$userInformation->landline_number?>" name="landline_number" id="landline-number" class="form-control form-control-lg form-control-solid mask-landline-phone" placeholder="00 0000-0000">
                                                </div>
                                            </div>
                                            <!-- CONTACT NUMBER -->
                                            <div class="row gx-0 gx-md-2 mb-6">
                                            ...
                                            <div class="row gx-0 gx-md-2 mb-6">
                                                ...
                                                <div class="col-lg-8">
                                                    <input type="text" value="<?=$userInformation->tin?>" name="tin" id="tin" class="form-control form-control-lg form-control-solid mask-tin" placeholder="Tax Identification Number">
                                                </div>
                                            </div>
                                            <!-- GSIS/SSS ID NO -->
                                            <div class="row gx-0 gx-md-2 mb-6">
                                                ...
                                                <div class="col-lg-8">
                                                    <input type="text" value="<?=$userInformation->gsis_sss_no?>" name="gsis_sss_no" id="gsis-sss-no" class="form-control form-control-lg form-control-solid mask-sss" placeholder="GSIS/SSS ID Number">
                                                </div>
                                            </div>
                                            <!-- PAG-IBIG NO -->
                                            <div class="row gx-0 gx-md-2 mb-6">
                                                ...
                                                <div class="col-lg-8">
                                                    <input type="text" value="<?=$userInformation->pag_ibig_no?>" name="pag_ibig_no" id="pag-ibig-no" class="form-control form-control-lg form-control-solid mask-pagibig" placeholder="Pag-IBIG Number">
                                                </div>
                                            </div>
                                            <!-- PHILHEALTH NO -->
                                            <div class="row gx-0 gx-md-2 mb-6">
                                                ...
                                                <div class="col-lg-8">
                                                    <input type="text" value="<?=$userInformation->philhealth_no?>" name="philhealth_no" id="philhealth-no" class="form-control form-control-lg form-control-solid mask-philhealth" placeholder="PhilHealth Number">
                                                </div>
                                            </div>
                                            <!-- DISABILITY -->
                                            <div class="row gx-0 gx-md-2 mb-6">
                                                ...
                                                <div class="col-lg-8">
                                                    <select class="form-select form-control form-control-solid" aria-label="Disability" name="disability" id="disability">
                                                        <option value="" <?=$userInformation->disability == "" ? "selected" : "" ?>>None</option>
                                                        <?php $disabilities = ["Visual","Speech","Hearing","Physical"]; 
                                                            $is_other_disability = $userInformation->disability == "" ? false : !in_array($userInformation->disability, $disabilities);
                                                            foreach ($disabilities as $disability):
                                                        ?>
                                                            <option value="<?=$disability?>" <?=$userInformation->disability == $disability ? "selected" : "" ?>><?=$disability?></option>
                                                        <?php endforeach;?>
                                                        <option value="Others" <?=$is_other_disability ? "selected" : "" ?>>Others</option>
                                                    </select>
                                                    <input type="text" id="other-disability" class="form-control form-control-lg form-control-solid mt-2" value="<?=$is_other_disability ? $userInformation->disability : "" ?>" placeholder="Others, specify:" style="display:<?=$is_other_disability ? "show" : "none"?>;">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex-column " data-kt-stepper-element="content">
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <select class="form-select form-control form-control-solid" aria-label="Employment Status" name="employment_status" id="employment-status">
                                                        <?php foreach ($employment_status_types as $status => $types):?>
                                                            <option value="<?=$status?>" <?=$userInformation->employment_status == $status ? "selected" : "" ?> ><?=$status?></option>
                                                        <?php endforeach;?>
                                                    </select>
                                                    <select class="form-select form-control form-control-solid mt-2" aria-label="Employment Type" name="employment_type" id="employment-type">
                                                        <?php foreach ($employment_status_types as $status => $types):
                                                            ...
                                                            <option value="<?=$type?>" data-employment-status="<?=$status?>" <?=$userInformation->employment_type == $type ? "selected" : "" ?> <?= $userInformation->employment_status !== $status ? 'style="display: none;"' : ""?> ><?=$type?></option>
                                                        <?php   endforeach;
                                                            endforeach;?>
                                                    </select>
                                                    <input type="text" id="other-employment-type" name="other_employment_type" value="<?=$userInformation->other_employment_type?>" class="form-control form-control-lg form-control-solid mt-2" value="" placeholder="Others, specify:" style="display: <?=$userInformation->employment_type == "Others" ? "show" : "none" ?>;">
                                                    <input type="text" id="terminated-laidoff-abroad" name="terminated_laidoff_abroad" value="<?=$userInformation->terminated_laidoff_abroad?>" class="form-control form-control-lg form-control-solid mt-2" value="" placeholder="Specify Country:" style="display: <?=$userInformation->employment_type == "Terminated/Laidoff(abroad)" ? "show" : "none" ?>;">
                                            ...
                                            <div class="row gx-0 gx-md-2 mb-6">
                                                ...
                                                <div class="col-lg-8">
                                                    <select class="form-select form-control form-control-solid" aria-label="Actively Looking" name="is_actively_looking" id="is-actively-looking">
                                                        <option value="1" <?=$userInformation->is_actively_looking == 1 ? "selected" : "" ?> >Yes</option>
                                                        <option value="0" <?=$userInformation->is_actively_looking == 0 ? "selected" : "" ?> >No</option>
                                                    </select>
                                                    <div id="actively-looking-duration-container" style="display: <?=$userInformation->is_actively_looking_since ? "block" : "none"?>;">
                                                        <label class="col-form-label fw-semibold fs-6 pb-0 ps-2">How long have you been looking for work?</label>
                                                        <input type="text" list="actively-looking-duration-list" id="actively-looking-duration" name="is_actively_looking_since" value="<?=$userInformation->is_actively_looking_since?>" class="form-control form-control-lg form-control-solid mt-2" placeholder="Example: 3 months">
                                            ...
                                            <div class="row gx-0 gx-md-2 mb-6">
                                                ...
                                                <div class="col-lg-8">
                                                    <select class="form-select form-control form-control-solid" aria-label="Work Immediately" name="will_work_immediately" id="will-work-immediately">
                                                        <option value="1" <?=$userInformation->will_work_immediately == 1 ? "selected" : ""?> >Yes</option>
                                                        <option value="0" <?=$userInformation->will_work_immediately == 0 ? "selected" : ""?> >No</option>
                                                    </select>
                                                    <div id="work-immediately-when-container" style="display: <?=$userInformation->when_will_work_immediately ? "block" : "none"?>;">
                                                        <label class="col-form-label fw-semibold fs-6 pb-0 ps-2">If no, when?</label>
                                                        <input type="text" list="work-immediately-when-list" id="work-immediately-when" name="when_will_work_immediately" value="<?=$userInformation->when_will_work_immediately?>" class="form-control form-control-lg form-control-solid mt-2" placeholder="Example: Within 3 months">
                                            ...
                                            <div class="row gx-0 gx-md-2 mb-6">
                                                ...
                                                <div class="col-lg-8">
                                                    <select class="form-select form-control form-control-solid" aria-label="4Ps Beneficiary" name="is_4ps_beneficiary" id="4Ps-beneficiary">
                                                        <option value="1" <?=$userInformation->is_4ps_beneficiary == 1 ? "selected" : ""?> >Yes</option>
                                                        <option value="0" <?=$userInformation->is_4ps_beneficiary == 0 ? "selected" : ""?> >No</option>
                                                    </select>
                                                    <div id="4Ps-beneficiary-container" style="display: <?=$userInformation->{'4ps_beneficiary_household_no'} ? "block" : "none"?>;">
                                                        <label class="col-form-label fw-semibold fs-6 pb-0 ps-2">If yes, Household ID No.</label>
                                                        <input type="text" id="4ps-beneficiary-household-no" name="4ps_beneficiary_household_no" value="<?=$userInformation->{'4ps_beneficiary_household_no'}?>" class="form-control form-control-lg form-control-solid mt-2" placeholder="Household ID No.">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row gx-0 gx-md-2 mb-3">
                                                ...
                                                <div class="col-lg-8">
                                                    <ul class="text-blue fs-5 " id="preferred-occupation-list">
                                                        <?php
                                                            $preferred_occupation = json_decode($userInformation->preferred_occupation ? $userInformation->preferred_occupation : "[]");
                                                            foreach ($preferred_occupation as $key => $occupation):
                                                        ?>
                                                        <li class="mb-3">
                                                            <span class="text-dark preferred-occupation list-data"><?=$occupation?></span>
                                            ...
                                            <div class="row gx-0 gx-md-2 mb-3">
                                                ...
                                                <div class="col-lg-8">
                                                    <ul class="text-blue fs-5 " id="preferred-work-location-local-list">
                                                        <?php
                                                            $preferred_occupation_local = json_decode($userInformation->preferred_work_location_local);
                                                            foreach ($preferred_occupation_local as $key => $local):
                                                        ?>
                                                        <li class="mb-3">
                                                            <span class="text-dark preferred-work-location-local list-data"><?=$local?></span>
                                            ...
                                            <div class="row gx-0 gx-md-2 mb-3">
                                                ...
                                                <div class="col-lg-8">
                                                    <ul class="text-blue fs-5 " id="preferred-work-location-abroad-list">
                                                        <?php
                                                            $preferred_occupation_abroad = json_decode($userInformation->preferred_work_location_abroad);
                                                            foreach ($preferred_occupation_abroad as $key => $abroad):
                                                        ?>
                                                        <li class="mb-3">
                                                            <span class="text-dark preferred-work-location-abroad list-data"><?=$abroad?></span>
                                                ...
                                                <div class="col-lg-8">
                                                    <div class="fv-row fv-plugins-icon-container mb-3 mb-lg-0">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" name="expected_salary" value="<?=$userInformation->expected_salary?>" id="expected-salary" class="form-control form-mask mask-money form-control-lg form-control-solid" required placeholder="0.00">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row gx-0 gx-md-2 mb-6">
                                                ...
                                                <div class="col-lg-8">
                                                    <input type="text" name="passport_no" value="<?=$userInformation->passport_no?>" id="passport" class="mask-passport form-control form-control-lg form-control-solid" placeholder="Passport ID No.">
                                                    <div id="passport-expiry-container" style="display: <?=$userInformation->passport_no ? "block" : "none"?>;">
                                                        <label class="col-form-label fw-semibold fs-6 pb-0 ps-2">Passport Expiration</label>
                                                        <input type="date" name="passport_expiry" value="<?=$userInformation->passport_expiry?>" id="passport-expiry" class="form-control form-control-lg form-control-solid mt-2" placeholder="Passport Expiration">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                            ...
                                                            <div id="educational-background-<?=$index?>" class="accordion-collapse collapse <?=$index==0?"show":""?>" aria-labelledby="educational-background-header" data-bs-parent="#educational-background-accordion">
                                                                <div class="accordion-body row">
                                                                    <div class="col-12">
                                                                        ...
                                                                        <input type="text" class="form-control form-control-solid mb-3" placeholder="<?=ucwords($education)?> School" name="<?=$name_education?>_school_name" value="<?=$userInformation->{$name_education."_school_name"}?>">
                                                                    </div>
                                                                    <?php if($index>1):?>
                                                                    <div class="col-12 <?=$index==0?"d-none":""?>">
                                                                        <label class="col-form-label fw-semibold fs-6 p-0 ps-1">Course</label>
                                                                        <input type="text" class="form-control form-control-solid mb-3" placeholder="<?=ucwords($education)?> Course" name="<?=$name_education?>_course" value="<?=$userInformation->{$name_education."_course"}?>">
                                                                    </div>
                                                                    <?php endif;?>
                                                                    ...
                                                                    <div class="col-6">
                                                                        ...
                                                                        <div class="form-check form-switch form-check-custom form-check-solid ps-1">
                                                                            <input class="form-check-input education-is-undergrad" type="checkbox" value="1" name="<?=$name_education?>_is_undergrad" id="<?=$id_education?>-is-undergrad" <?=$userInformation->{$name_education."_is_undergrad"} ? "checked" : "" ?>/>
                                                                            <label class="form-check-label" for="<?=$id_education?>-is-undergrad">
                                                                            <?=$userInformation->{$name_education."_is_undergrad"} ? "Yes" : "No" ?>
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-6">
                                                                        ...
                                                                        <input type="number" name="<?=$name_education?>_year_graduated" value="<?=$userInformation->{$name_education."_year_graduated"}?>"  min="<?=$min_year?>" max="<?=$max_year?>" class="form-control form-control-solid mb-3 year-graduated" placeholder="2000" <?=$userInformation->{$name_education."_is_undergrad"} ? "disabled" : "" ?>>
                                                                    </div>

                                                                    <div class="col-6 undergrad-level" style="display: <?=$userInformation->{$name_education."_is_undergrad"} ? "block" : "none" ?>;">
                                                                        <label class="col-form-label fw-semibold fs-6 p-0 ps-1">What level?</label>
                                                                        <input type="text" name="<?=$name_education?>_last_level" value="<?=$userInformation->{$name_education."_last_level"}?>" class="form-control form-control-solid mb-3 school-undergrad-level" placeholder="Example: <?=$grade_level_placeholders[$index]?>">
                                                                    </div>
                                                                    <div class="col-6 undergrad-year" style="display: <?=$userInformation->{$name_education."_is_undergrad"} ? "block" : "none" ?>;">
                                                                        <label class="col-form-label fw-semibold fs-6 p-0 ps-1">Year last attended</label>
                                                                        <input type="number" name="<?=$name_education?>_last_year_attended" value="<?=$userInformation->{$name_education."_last_year_attended"} ? $userInformation->{$name_education."_last_year_attended"} : $min_year?>" min="<?=$min_year?>" max="<?=$max_year?>" class="form-control form-control-solid mb-3 school-undergrad-year" placeholder="2000">
                                                                    </div>
                                                                    <div class="col-12">
                                                                        <label class="col-form-label fw-semibold fs-6 p-0 ps-1">Award</label>
                                                                        <input type="text" class="form-control form-control-solid mb-3" placeholder="<?=ucwords($education)?> School Award" name="<?=$name_education?>_award" value="<?=$userInformation->{$name_education."_award"}?>" >
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <table class="table table-align-middle">
                                                        ...
                                                        <tbody>
                                                            <?php
                                                                ...
                                                                $language_dialect_proficiency = json_decode($userInformation->language_dialect_proficiency);
                                                                foreach ($languages as $index => $language):
                                                                    if($language!="others"){
                                                                        $current_language = $language_dialect_proficiency[$index]->{ucfirst($language)};
                                                                    }else{
                                                                        $current_language = $language_dialect_proficiency[$index]->{array_keys((array)$language_dialect_proficiency[$index])[0]};
                                                                    }
                                                            ...
                                                            <tr data-language="<?=$language?>" class="language-row">
                                                                <td>
                                                                    <?php if($language == "others"):?>
                                                                        <input type="text" class="form-control language-name form-control-solid" value="<?=array_keys((array)$language_dialect_proficiency[$index])[0]?>" placeholder="Others:">
                                                                    <?php else:?>
                                                                ...
                                                                <td class="text-center">
                                                                    <input class="form-check-input language-checkbox" type="checkbox" name="<?=$language?>-read" data-data-name="read" <?=$current_language->read ? "checked" : "" ?> />
                                                                </td>
                                                                <td class="text-center">
                                                                    <input class="form-check-input language-checkbox" type="checkbox" name="<?=$language?>-write" data-data-name="write" <?=$current_language->write ? "checked" : "" ?> />
                                                                </td>
                                                                <td class="text-center">
                                                                    <input class="form-check-input language-checkbox" type="checkbox" name="<?=$language?>-speak" data-data-name="speak" <?=$current_language->speak ? "checked" : "" ?> />
                                                                </td>
                                                                <td class="text-center">
                                                                    <input class="form-check-input language-checkbox" type="checkbox" name="<?=$language?>-understand" data-data-name="understand" <?=$current_language->understand ? "checked" : "" ?> />
                                                                </td>
                                                            </tr>
                                                            <?php
                                                                endforeach;
                                            ...
                                            <div class="row gx-0 gx-md-2 mb-6">
                                                ...
                                                <div class="col-lg-11 offset-lg-1 table-responsive">
                                                    <table class="table table-align-middle" id="technical-vocational-table">
                                                        ...
                                                        <tbody>
                                                            <?php
                                                                $technical_vocational_and_other_training = json_decode($userInformation->technical_vocational_and_other_training);
                                                                foreach ($technical_vocational_and_other_training as $training):
                                                            ?>
                                                            <tr>
                                                                <td>
                                                                    <input type="text" class="table-data form-control form-control-solid required technical-vocational-training" value="<?=$training->training?>" data-data-name="training" >
                                                                </td>
                                                                <td>
                                                                    <input type="text" class="table-data form-control form-control-solid required technical-vocational-duration" value="<?=$training->duration?>" data-data-name="duration" >
                                                                </td>
                                                                <td>
                                                                    <input type="text" class="table-data form-control form-control-solid required technical-vocational-institution" value="<?=$training->institution?>" data-data-name="institution" >
                                                                </td>
                                                                <td>
                                                                    <input type="text" class="table-data form-control form-control-solid required technical-vocational-certificates" value="<?=$training->certificates?>" placeholder="" data-data-name="certificates" >
                                                                </td>
                                                                <td class="p-0">
                                                            ...
                                                            <?php 
                                                                endforeach;
                                                                if(count($technical_vocational_and_other_training)==0):
                                                            ?>
                                                            <tr>
                                                                <td>
                                            ...
                                            <div class="row gx-0 gx-md-2 mb-6">
                                                ...
                                                <div class="col-lg-11 offset-lg-1 table-responsive">
                                                    <table class="table table-align-middle" id="eligibility-table">
                                                        ...
                                                        <tbody>
                                                            <?php
                                                                $eligibilities = json_decode($userInformation->eligibility);
                                                                foreach ($eligibilities as $eligibility):
                                                            ?>
                                                            <tr>
                                                                <td>
                                                                    <input type="text" class="table-data form-control form-control-solid required eligibility-civil-service" value="<?=$eligibility->eligibility?>" data-data-name="eligibility" >
                                                                </td>
                                                                <td>
                                                                    <input type="text" class="table-data form-control form-control-solid required eligibility-rating" value="<?=$eligibility->rating?>" data-data-name="rating" >
                                                                </td>
                                                                <td>
                                                                    <input type="date" class="table-data form-control form-control-solid required eligibility-date" value="<?=$eligibility->date?>" data-data-name="date" >
                                                                </td>
                                                                <td class="p-0">
                                            ...
                                            <div class="row gx-0 gx-md-2 mb-6">
                                                ...
                                                <div class="col-lg-11 offset-lg-1 table-responsive">
                                                    <table class="table table-align-middle" id="professional-license-table">
                                                        ...
                                                        <tbody>
                                                            <?php
                                                                $professional_licenses = json_decode($userInformation->professional_license);
                                                                foreach ($professional_licenses as $professional_license):
                                                            ?>
                                                            <tr>
                                                                <td>
                                                                    <input type="text" class="table-data form-control form-control-solid required professional-license" value="<?=$professional_license->{"professional license"}?>" data-data-name="professional license">
                                                                </td>
                                                                <td>
                                                                    <input type="date" class="table-data form-control form-control-solid required professional-license-valid-until" value="<?=$professional_license->{"valid until"}?>" data-data-name="valid until">
                                                                </td>
                                                                <td class="p-0">
                                                            ...
                                                            <?php 
                                                                endforeach;
                                                                if(count($professional_licenses)==0):
                                                            ?>
                                                            <tr>
                                                                <td>
                                            ...
                                            <div class="row gx-0 gx-md-2 mb-6">
                                                ...
                                                <div class="col-lg-12 table-responsive">
                                                    <table class="table table-align-middle" id="work-experience-table">
                                                        ...
                                                        <tbody>
                                                            <?php
                                                                $work_experiences = json_decode($userInformation->work_experience);
                                                                foreach ($work_experiences as $work_experience):
                                                            ?>
                                                            <tr>
                                                                <td>
                                                                    <input type="text" class="form-control table-data form-control-solid required work-experience-position" value="<?=$work_experience->{"position"}?>" data-data-name="position" >
                                                                </td>
                                                                <td>
                                                                    <input type="text" class="form-control table-data form-control-solid required work-experience-company-name" value="<?=$work_experience->{"company name"}?>" data-data-name="company name" >
                                                                </td>
                                                                <td>
                                                                    <input type="text" class="form-control table-data form-control-solid required work-experience-address" value="<?=$work_experience->{"address"}?>" data-data-name="address" >
                                                                </td>
                                                                <td>
                                                                    <input type="text" class="form-control table-data form-control-solid required work-experience-inclusive-dates" value="<?=$work_experience->{"inclusive dates"}?>" data-data-name="inclusive dates" >
                                                                </td>
                                                                <td>
                                                                    ...
                                                                    ?>
                                                                    <option value="<?=$value?>" <?=$work_experience->{"status"} == $value ? "selected" : "" ?>><?=$value?></option>
                                                                    <?php endforeach;?>
                                            ...
                                            <div class="row gx-0 gx-md-2 mb-6">
                                                ...
                                                <div class="col-lg-12 table-responsive">
                                                    <div class="row m-0 py-1" id="other-skills-acquired-without-formal-training">
                                                        <?php
                                                            $skills_acquired = json_decode($userInformation->other_skills_acquired_without_formal_training);
                                                            $skills_array = [
                                                        ...
                                                        ?>
                                                            <div class="form-check mb-3 col-6 col-md-4">
                                                                <input class="form-check-input skill-checkbox" type="checkbox" data-skill-name="<?=$skill?>" id="<?=str_replace(" ", "-",strtolower($skill))?>-skills" <?=in_array($skill, $skills_acquired)?"checked":""?> />
                                                        ...
                                                        <?php endforeach;?>
                                                        <?php
                                                            $other_skill = array_diff($skills_acquired, $skills_array);
                                                        ?>
                                                            <div class="form-check mb-3 col-6 col-md-4">
                                                                <input class="form-check-input" type="checkbox" id="others-skills" <?=count($other_skill)?"checked":""?>/>
                                                                <input type="text" class="form-control form-control-sm form-control-solid" placeholder="Other:" id="others-skills-input" value="<?=count($other_skill)?array_values($other_skill)[0]:""?>">
                                                            </div>
                                                    </div>
                                                </div>
                                            </div>
