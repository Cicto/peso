                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                    <input type="text" name="place_of_death" id="place-of-death"
                                        class="form-control form-control-lg form-control-solid"
                                        placeholder="Place of Death" value="">
                                    <div class="fv-plugins-message-container invalid-feedback"></div>
                                </div>
                            </div>
                            <!-- <hr> -->
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input type="date" name="date_of_death" id="date-of-death"
                                        class="form-control form-control-lg form-control-solid"
                                        placeholder="Date of Death" value="">
                                </div>
                            </div>
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                    <input type="text" name="requester_name" id="requester-name"
                                        class="form-control form-control-lg form-control-solid"
                                        placeholder="Requester's Full Name" value="">
                                    <div class="fv-plugins-message-container invalid-feedback"></div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <select class="form-select form-control form-control-solid"
                                        aria-label="Default select example" name="relationship_to_the_deceased"
                                        name="relationship-to-the-deceased" required="">
