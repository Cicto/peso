...
<div id="kt_app_header" class="app-header position-relative">
    ...
    <div class="app-container container-xxl d-flex align-items-stretch justify-content-between" id="kt_app_header_container">
        ...
        <div class="d-none d-lg-flex align-items-center flex-grow-1 flex-lg-grow-0 me-lg-15">
            <a href="<?=base_url()?>">
                <img alt="Logo" src="<?=base_url()?>/public/assets/media/peso/logo.svg" class="h-20px h-lg-30px app-sidebar-logo-default theme-light-show">
                <img alt="Logo" src="<?=base_url()?>/public/assets/media/peso/logo-dark.svg" class="h-20px h-lg-30px app-sidebar-logo-default theme-dark-show">
            </a>
        </div>
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
            <a href="<?=base_url()?>/home" class="d-lg-none">
                <img alt="Logo" src="<?=base_url()?>/public/assets/media/peso/logo.svg" class="h-30px">
            </a>
        </div>
        <!--end::Mobile logo-->
        ...
        <div class="d-flex align-items-stretch justify-content-end flex-lg-grow-1" id="kt_app_header_wrapper">
            ...
            <div class="app-header-menu app-header-mobile-drawer align-items-stretch" data-kt-drawer="true" data-kt-drawer-name="app-header-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="250px" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_app_header_menu_toggle" data-kt-swapper="true" data-kt-swapper-mode="{default: 'append', lg: 'prepend'}" data-kt-swapper-parent="{default: '#kt_app_body', lg: '#kt_app_header_wrapper'}">
                ...
                <div class="menu menu-rounded menu-column menu-lg-row my-5 my-lg-0 align-items-center fw-semibold px-2 px-lg-0" id="kt_app_header_menu" data-kt-menu="true">
                    ...
                    <div hidden data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item here menu-here-bg menu-lg-down-accordion me-0 me-lg-2">
                        <!--begin:Menu link-->
                    ...
                    <div hidden data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion me-0 me-lg-2">
                        <!--begin:Menu link-->
                        <span class="menu-link">
                    ...
                    <div hidden data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion menu-sub-lg-down-indention me-0 me-lg-2">
                        <!--begin:Menu link-->
                        <span class="menu-link">
                    ...
                    <div class="menu-item w-75 mx-3">
                        <a href="<?=base_url()?>/jobs/my_applications" class="menu-link menu-link-hover menu p-0">
                            <span class="menu-title h-35px w-100 w-md-40px h-md-40px position-relative">
                                ...
                                <svg class="d-block mx-3 m-md-auto" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" style="fill: var(--kt-text-muted);" >
            ...
            <div class="app-navbar flex-shrink-0">
                ...
                <div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                    ...
                    <?php else:?>
                        <a href="<?=base_url()?>/login" class="btn btn-sm btn-blue">Login 
                        <!--begin::Svg Icon | path: /var/www/preview.keenthemes.com/kt-products/docs/metronic/html/releases/2023-01-30-131017/core/html/src/media/icons/duotune/arrows/arr076.svg-->
                        <span class="svg-icon svg-icon-white svg-icon-2 m-0">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
