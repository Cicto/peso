    ...
    <div class="app-container container-fluid d-flex align-items-stretch justify-content-between"
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
            <a href="../../demo1/dist/index.html" class="d-lg-none">
                <img alt="Logo" src="<?=base_url()?>/public/assets/media/peso/logo-small.svg" class="h-30px theme-light-show" data-bs-theme="light">
                <img alt="Logo" src="<?=base_url()?>/public/assets/media/peso/logo-small-dark.svg" class="h-30px theme-dark-show" data-bs-theme="dark">
            </a>
        </div>
        <!--end::Mobile logo-->
        ...
        <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1" id="kt_app_header_wrapper">
                                    ...
                                    <ul class="nav nav-stretch nav-line-tabs fw-bold fs-6 p-0 p-lg-10 flex-nowrap flex-grow-1"
                                        ...
                                        <li class="nav-item mx-lg-1" role="presentation">
                                            <a class="nav-link py-3 py-lg-6 text-active-primary" href="#"
                                                ...
                                                aria-selected="false" tabindex="-1" role="tab">Account</a>
                                        </li>
                                        <!--end:Nav item-->
                                        <!--begin:Nav item-->
                                        <li class="nav-item mx-lg-1" role="presentation">
                                            <a class="nav-link py-3 py-lg-6 text-active-primary" href="#"
                                                ...
                                                aria-selected="false" tabindex="-1" role="tab">Authentication</a>
                                        </li>
                                        <!--end:Nav item-->
                                        <!--begin:Nav item-->
                                        <li class="nav-item mx-lg-1" role="presentation">
                                            <a class="nav-link py-3 py-lg-6 text-active-primary" href="#"
                                                ...
                                                aria-selected="false" tabindex="-1" role="tab">Utilities</a>
                                        </li>
                                        <!--end:Nav item-->
                                        <!--begin:Nav item-->
                                        <li class="nav-item mx-lg-1" role="presentation">
                                            <a class="nav-link py-3 py-lg-6 text-active-primary" href="#"
                                                ...
                                                aria-selected="false" tabindex="-1" role="tab">Widgets</a>
                                        </li>
                                        <!--end:Nav item-->
                                    </ul>
                                </div>
                                ...
                                <div class="tab-content py-4 py-lg-8 px-lg-7">
                                    ...
                                    <div class="tab-pane active w-lg-1000px" id="kt_app_header_menu_pages_pages"
                                        ...
                                        <div class="row">
                                            ...
                                            <!--begin:Col-->
                                            <div class="col-lg-4">
                                                <img src="<?=base_url()?>/public/assets/media/stock/600x600/img-82.jpg"
                                    ...
                                    <div class="tab-pane w-lg-600px" id="kt_app_header_menu_pages_account"
                                        ...
                                        <div class="row">
                                            ...
                                            <!--begin:Col-->
                                            <div class="col-lg-7">
                                                <img src="<?=base_url()?>/public/assets/media/stock/900x600/46.jpg"
                                                    class="rounded mw-100" alt="" id="kjahsdkjhasdkjahsd">
                                            </div>
                                            <!--end:Col-->
                                        </div>
                                        <!--end:Row-->
                                    ...
                                    <div class="tab-pane w-lg-1000px" id="kt_app_header_menu_pages_utilities"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-5 pe-lg-5">
                                                <img src="<?=base_url()?>/public/assets/media/stock/600x600/img-84.jpg"
                                                    class="rounded mw-100" alt="">
                                            </div>
                                            <!--end:Col-->
                                        </div>
                                    ...
                                    <div class="tab-pane w-lg-500px" id="kt_app_header_menu_pages_widgets"
                                        ...
                                        <div class="row">
                                            ...
                                            <!--begin:Col-->
                                            <div class="col-lg-8">
                                                <img src="<?=base_url()?>/public/assets/media/stock/900x600/44.jpg"
                                                    class="rounded mw-100" alt="">
                                            </div>
                                            <!--end:Col-->
                                        </div>
                            ...
                            <div class="menu-active-bg pt-1 pb-3 px-3 py-lg-6 px-lg-6" data-kt-menu-dismiss="true">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 mb-3 py-lg-3 pe-lg-8 d-flex align-items-center">
                                        <img src="<?=base_url()?>/public/assets/media/stock/900x600/45.jpg"
                                            class="rounded mw-100" alt="">
                                    </div>
                                    <!--end:Col-->
                                </div>
                        ...
                        <div
                            ...
                            <div class="menu-item">
                                ...
                                <a class="menu-link"
                                    ...
                                    target="blank" data-bs-toggle="tooltip" data-bs-trigger="hover"
                                    data-bs-dismiss="click" data-bs-placement="right" data-kt-initialized="1">
                                    <span class="menu-icon">
                                        <!--begin::Svg Icon | path: icons/duotune/general/gen002.svg-->
                                        <span class="svg-icon svg-icon-3">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
            ...
            <div class="app-navbar flex-shrink-0">
                ...
                <div hidden class="app-navbar-item d-lg-none ms-2 me-n3" title="Show header menu">
