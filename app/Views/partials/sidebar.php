<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="225px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_sidebar_mobile_toggle">
    <div class="app-sidebar-logo px-6 text-center" id="kt_app_sidebar_logo">
        <!--begin::Logo image-->
        <a href="<?=base_url()?>/dashboard" class="mx-auto">
            <img alt="Logo" src="<?= base_url()?>/public/assets/media/peso/logo-dark.svg" class="h-30px app-sidebar-logo-default">
            <img alt="Logo" src="<?= base_url()?>/public/assets/media/peso/logo-small-dark.svg" class="h-30px app-sidebar-logo-minimize">
        </a>
        <!--end::Logo image-->
            ...
            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
                <div class="menu-item here">
                    ...
                    <a class="menu-link" href="<?=base_url()?>/dashboard">
                        ...
                        <span hidden class="menu-arrow"></span>
                    </a>
                    <!--end:Menu link-->
                    <!--begin:Menu sub-->
                    <div hidden class="menu-sub menu-sub-accordion" kt-hidden-height="248" style="display: none; overflow: hidden;">
                        <!--begin:Menu item-->
                        <div class="menu-item">
                            <!--begin:Menu link-->
                ...
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link" href="<?= base_url().'/home'?>" target="_blank">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: /var/www/preview.keenthemes.com/kt-products/docs/metronic/html/releases/2023-01-30-131017/core/html/src/media/icons/duotune/layouts/lay006.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="menu-item">
                    <a class="menu-link" href="<?= base_url().'/logs'?>">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/abstract/abs014.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
