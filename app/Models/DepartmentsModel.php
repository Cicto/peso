...
class UsersModel
{
    ...
    {
        return $this->db->table('users')
                ->select('users.id, users.email,users.username, user_info.firstname, user_info.middlename, user_info.lastname, user_info.birthdate, user_info.role, user_info.dept_id, users.active')
    ...
    {
        return $this->db->table('users')
                ->select('users.id, users.email, users.username, user_info.firstname, user_info.lastname, users.active, users.status')
                ->join('user_info', 'user_info.user_id = users.id', 'left');
    }
